...
conn.execute('''CREATE TABLE IF NOT EXISTS doctor(uid varchar(10) PRIMARY KEY,"fname" TEXT, "lname" TEXT, email varchar(30) NOT NULL,  mob varchar(30) NOT NULL,  dob varchar(30) NOT NULL,  gender varchar(30) NOT NULL,  regnum varchar(20) NOT NULL,  Specialization varchar(30) NOT NULL,add varchar(30) NOT NULL, state varchar(15) NOT NULL,  city varchar(30) NOT NULL,  district varchar(30) NOT NULL,  pin integer NOT NULL,  addr1 varchar(30) NOT NULL,  addr2 varchar(30) NOT NULL ) ''')
